...
export function Contact() {
  return (
    <section id="contact" className="section-anchor mx-auto max-w-6xl pt-14 pb-10 px-4 sm:px-6">
      ...
      <div data-reveal className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <div
          data-reveal
          className="mt-16 rounded-2xl border border-border/80 bg-[#07030d]/70 px-6 py-14 shadow-[0_24px_80px_-64px_rgba(0,0,0,0.95)] backdrop-blur-sm md:px-12"
        >
          <a
            href="mailto:bshirude2@gmail.com"
            className="hover-zoom inline-flex items-center gap-3 text-xl font-semibold text-accent transition-colors hover:text-foreground md:text-2xl"
          >
